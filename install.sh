...
(
  ...
  if [ -n "${VERSION:-}" ]; then
    DOWNLOAD_URL="https://github.com/stepchowfun/shell-agent/releases/download/v$VERSION/$FILENAME"
  else
    DOWNLOAD_URL="https://github.com/stepchowfun/shell-agent/releases/latest/download/$FILENAME"
  fi
